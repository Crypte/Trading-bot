...
def generate_signal_bb(data):
    """Générer des signaux d'achat/vente basés sur la Bande inférieure et supérieure de Bollinger."""
    ...
    for i in range(1, len(data)):
        ...
        # Condition de vente basée sur la bande supérieure
        elif close_price >= data['bb_upper'].iloc[i]:
